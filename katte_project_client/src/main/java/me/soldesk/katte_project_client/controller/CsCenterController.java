...
/* ───────────────────────────────────────────────────────────────────────────
   ...
   ─────────────────────────────────────────────────────────────────────────── */
    ...
    @GetMapping("/announce")
    public String showAnnounceList(Model model) {
        System.out.println("공지 리스트 컨트롤러 탔어요");
        List<CsAnnounceBean> announces = csCenterService.getCsAnnounceBean(10, 0);
...
/*    @GetMapping("/faq")
    ...
    public String showFaqList(Model model) {
        System.out.println("자주 묻는 질문 리스트 컨트롤러 탔어요");
        List<CsFaqBean> faqs = csCenterService.getCsFaqBean(10, 0);
        System.out.println("받은 faq 수: " + faqs.size());
